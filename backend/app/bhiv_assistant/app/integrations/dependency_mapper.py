...
class DependencyMapper:
    ...
    def get_dependencies_for_system(self, system: SystemType) -> List[Dependency]:
        ...
        return [
            ...
            if dep.from_system == system or dep.to_system == system
        ]
    ...
    def generate_dependency_report(self, output_path: str = "reports/dependencies.json"):
        ...
        report = {
            ...
            "systems": {
                system.value: {
                    "dependencies": [
                        asdict(dep) for dep in self.get_dependencies_for_system(system)
                    ],
                    "endpoints": [
                        asdict(ep) for ep in self.get_endpoints_for_system(system)
                    ]
                }
