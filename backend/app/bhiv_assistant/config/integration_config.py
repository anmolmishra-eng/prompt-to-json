...
class Task7Config(BaseSettings):
    ...
    base_url: AnyHttpUrl = Field(default="http://localhost:8000", env="TASK7_BASE_URL")
...
class SohumMCPConfig(BaseSettings):
    ...
    base_url: AnyHttpUrl = Field(default="https://ai-rule-api-w7z5.onrender.com", env="SOHUM_BASE_URL")
...
class RanjeetRLConfig(BaseSettings):
    ...
    base_url: AnyHttpUrl = Field(default="https://api.yotta.com", env="RANJEET_BASE_URL")
...
class BHIVConfig(BaseSettings):
    ...
    supabase_url: str = Field(default="https://dntmhjlbxirtgslzwbui.supabase.co", env="SUPABASE_URL")
...
class WorkflowConfig(BaseSettings):
    ...
    prefect_api_url: Optional[AnyHttpUrl] = Field(default="http://localhost:4200", env="PREFECT_API_URL")
