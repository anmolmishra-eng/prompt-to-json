...
def generate_compliance_report(
    ...
    report = {
        ...
        "summary": {
            ...
            "errors": len(errors),
            "overall_compliance_rate": f"{(len(compliant) / len(validation_results) * 100):.1f}%" if validation_results else "0%"
        },
...
async def compliance_validation_flow(
    ...
    validation_tasks = [
        validate_design_compliance(design, config.bhiv_api_url)
