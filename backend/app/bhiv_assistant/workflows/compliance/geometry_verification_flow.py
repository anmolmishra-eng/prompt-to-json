...
@flow(
    name="geometry-verification",
    description="Verify GLB geometry outputs meet quality standards",
    version="1.0"
)
async def geometry_verification_flow(
    ...
    verification_tasks = [
        verify_glb_file(glb_file, config.max_file_size_mb)
