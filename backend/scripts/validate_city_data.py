...
def validate_city_data():
    ...
    for city in City:
        ...
        total_tests = len([k for k in result["tests"].keys() if not k.endswith("_count") and not k.endswith("_base") and not k.endswith("_version")])
        ...
        for test_name, test_result in result["tests"].items():
            if not test_name.endswith("_count") and not test_name.endswith("_base") and not test_name.endswith("_version"):
