...
class BackendDemo:
    ...
    def evaluate_spec(self, spec_id: str, rating: int = 4, notes: str = "Looks good", user_id: str = "demo_user") -> Dict[str, Any]:
    ...
    def iterate_spec(self, spec_id: str, strategy: str = "improve_materials", user_id: str = "demo_user") -> Dict[str, Any]:
    ...
    def get_report(self, spec_id: str) -> Dict[str, Any]:
        ...
        response = requests.get(
            f"{self.base_url}/api/v1/reports/{spec_id}",
            headers=self.headers
        )
